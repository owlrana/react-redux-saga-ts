...
interface InnerProps extends Omit<CheckboxProps, 'label'>, Omit<RadioProps, 'label'> {
...
const StyledLabel = styled('label')<InnerProps>((props) => {
  ...
  const color = getAccentColor(getColor(props));
...
export const Input = React.forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  ...
  const input = <StyledInput ref={ref} {...props} />;
  ...
  return (
    <MutationWrapper {...props}>
      <StyledInput ref={ref} id={id || name} {...props} />
    </MutationWrapper>
  );
});
