import { MutationProps, NumberOrString, RecursivePartial } from './common';
...
export type Breakpoints = string[] & { [key: string]: string };
...
interface Select extends BaseInput {
...
interface SizesAll extends Sizes {
  xs: NumberOrString;
  xl: NumberOrString;
}
...
interface SwitchOptions {
  innerBorderRadius: NumberOrString;
  marginLabel: NumberOrString;
  sizes: {
    xs: SwitchItem;
    sm: SwitchItem;
    md: SwitchItem;
...
export type Variants = Extract<keyof Colors, string>;
...
export interface Theme extends MutationProps {
  alert: Alert;
  badge: Badge;
  borderColor: string;
