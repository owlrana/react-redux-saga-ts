...
export var StyledSVGWrapper = styled('div')(function () { return css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    align-items: center;\n    display: flex;\n    justify-content: center;\n    position: relative;\n  "], ["\n    align-items: center;\n    display: flex;\n    justify-content: center;\n    position: relative;\n  "]))); }, sx, system);
export var StyledSVG = styled('svg')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  left: 50%;\n  margin-bottom: 20px;\n  overflow: visible;\n  position: absolute;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  z-index: -1;\n"], ["\n  left: 50%;\n  margin-bottom: 20px;\n  overflow: visible;\n  position: absolute;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  z-index: -1;\n"])));
export var StyledPath = styled('path')(function (props) {
    var invert = props.invert, stroke = props.stroke;
    var color = getColor(props);
    return css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    ", ";\n    fill: ", ";\n    stroke: ", ";\n    stroke-width: ", ";\n    transition: d 0.2s;\n  "], ["\n    ", ";\n    fill: ", ";\n    stroke: ", ";\n    stroke-width: ", ";\n    transition: d 0.2s;\n  "])), baseStyles, invert ? 'none' : color, invert ? color : 'none', invert ? px(stroke) : 0);
});
export var Circle = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(StyledSVGWrapper, __assign({}, props),
        React.createElement(StyledSVG, __assign({ height: size * 0.9 + "px", preserveAspectRatio: "xMidYMid", ref: ref, version: "1.1", viewBox: "0 0 256 256", width: size * 0.9 + "px", xmlns: "http://www.w3.org/2000/svg" }, rest),
            React.createElement(StyledPath, __assign({ d: circle.current }, props))),
        children));
});
Circle.defaultProps = {
    animate: false,
